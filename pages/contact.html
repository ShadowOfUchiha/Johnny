    ...
    <section id="navbar">
        <div class="bg-dark py-3">
            ...
            <button type="button" class="navbaritems" onclick="loadHome()">Home</button>
                ...
                <button type="button" class="navbaritems active" onclick="loadContact()">Contact</button>
            </div>
        </div>
    </section>
    <section id="header">
        <div class="bg-image" style="background-image: url('./images/contact.jpg');">
            <div class="bg-cover">
                        ...
                        <div class="col-12 col-md-8 text-white text-center">
                            <div class="d-table h-100 w-100">
                                <div class="d-table-cell align-middle">
                                    <h1 class="mb-lg-3"><i>Contacteer <span class="highlight">mij</span></i></h1>
                                    <h5><i>Hoe kan je mij nou vinden?</i></h5>
        ...
        <div class="bg-dark py-5">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-11 col-md-5 col-lg-5 text-white text-left">
                        <article>
                            <h4 class="mb-3">Altijd beschikbaar</h4>
                            <p class="mb-4">Ik ben altijd beschikbaar via mijn telefoon of mail. Liever niet in de vakanties bellen maar ik update de website wel als ik niet beschikbaar ben. Als je iets voor mij kan betekenen en andersom dan hoor ik het graag!</p>
                            <footer>
                                <a target="_blank" href="https://www.instagram.com/j.o.hnny_/?hl=nl"><img src="./images/instagram-logo.png" height="40px" width="40px" alt="Instagram"></a>
                                <a target="_blank" href="https://www.linkedin.com/in/johnny-magielse-1649b7199/"><img src="./images/Linkedin_logo.png" height="40px" width="40px" alt="LinkedIn"></a>
                                <a class="ps-1" target="_blank" href="https://github.com/ShadowOfUchiha"><img src="./images/github-logo.png" height="40px" width="40px" alt="Github"></a>
                            </footer>
                        </article>
                    </div>
                    <div class="col-11 col-md-5 col-lg-5 mb-4">
                        <div id="block" class="card border-0 rounded bg-secondary p-2">
                            <p class="mt-3 mx-auto">Gegevens:</p>
                            <div class="row px-3 py-2">
                                <div class="col-12 col-md-12">
                                    <p class="small border-bottom pb-1">johnnymihai33@gmail.com</p>
                                </div>
                                <div class="col-12 col-md-12">
                                    <p class="small border-bottom pb-1">06 18201732</p>
                                </div>
                                <div class="col-12 col-md-12">
                                    <p class="small border-bottom">Jansteenstraat 87</p>
                                </div>
                                <div class="col-12 col-md-12">
                                    <p class="small border-bottom">3443GT Woerden</p>
                                </div>
                            </div>
                        </div>
                    </div>
