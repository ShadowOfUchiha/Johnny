                ...
                <div class="row justify-content-center">
                    <div class="col-11 col-md-7 col-lg-5 text-white text-center">
                        <article>
                            ...
                            <p>Ik ben Johnny Magielse en ik ben een 18 jarige Software Developer in opleiding. Ik zie coderen als een uitdaging en daarom probeer ik altijd net wat meer te geven.
                                Ik ben niet altijd de heilige want soms heb ik er geen zin in, maar als ik eenmaal begin ben ik niet te stoppen. Soms vergeet ik zelfs te eten.</p>
                        </article>
                    </div>
                </div>
            </div>
